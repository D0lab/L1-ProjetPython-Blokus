...
def build_plateau():
	...
	for i in range(taille_plateau+1):
		cnv.create_line(5+decalage,5+unity*i,(taille_plateau+0.05)*unity+decalage,5+unity*i)
		cnv.create_line(5+unity*i+decalage,5,5+unity*i+decalage,(taille_plateau+0.05)*unity)
