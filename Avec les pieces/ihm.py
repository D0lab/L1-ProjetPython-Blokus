...
def charger_root():
	def build_pieces_rouge():
		...
		pieces_rouge_loader = {
			...
			# "7-0-0-0-R" : (cnv2.create_rectangle((width_cnv2/2)+(taille_plateau*unity/2)+unity, 30, (width_cnv2/2)+(taille_plateau*unity/2)+unity*2, 30+unity, fill='red', outline='', tags="rect7-R")),
			# 	"7-1-0-1-R" : (cnv2.create_rectangle((width_cnv2/2)+(taille_plateau*unity/2)+unity*2, 30, (width_cnv2/2)+(taille_plateau*unity/2)+unity*3, 30+unity, fill='red', outline='', tags="rect7-R")),
			# 	"7-0-1-2-R" : (cnv2.create_rectangle((width_cnv2/2)+(taille_plateau*unity/2)+unity, (1*30)+(1*unity), (width_cnv2/2)+(taille_plateau*unity/2)+unity*2, (1*30)+(1*unity)+unity, fill='red', outline='', tags="rect7-R")),
			# 	"7-1-1-3-R" : (cnv2.create_rectangle((width_cnv2/2)+(taille_plateau*unity/2)+unity*2, (1*30)+(1*unity), (width_cnv2/2)+(taille_plateau*unity/2)+unity*3, (1*30)+(1*unity)+unity, fill='red', outline='', tags="rect7-R")),
   
			# "8-0-0-0-R" : (cnv2.create_rectangle((width_cnv2/2)+(taille_plateau*unity/2)+unity, 30, (width_cnv2/2)+(taille_plateau*unity/2)+unity*2, 30+unity, fill='red', outline='', tags="rect8-R")),
			# 	"8-1-0-1-R" : (cnv2.create_rectangle((width_cnv2/2)+(taille_plateau*unity/2)+unity*2, 30, (width_cnv2/2)+(taille_plateau*unity/2)+unity*3, 30+unity, fill='red', outline='', tags="rect8-R")),
			# 	"8-1-1-2-R" : (cnv2.create_rectangle((width_cnv2/2)+(taille_plateau*unity/2)+unity*2, (1*30)+(1*unity), (width_cnv2/2)+(taille_plateau*unity/2)+unity*3, (1*30)+(1*unity)+unity, fill='red', outline='', tags="rect8-R")),
			# 	"8-2-1-3-R" : (cnv2.create_rectangle((width_cnv2/2)+(taille_plateau*unity/2)+unity*3, (1*30)+(1*unity), (width_cnv2/2)+(taille_plateau*unity/2)+unity*4, (1*30)+(1*unity)+unity, fill='red', outline='', tags="rect8-R")),
   
			# "9-0-0-0-R" : (cnv2.create_rectangle((width_cnv2/2)+(taille_plateau*unity/2)+unity, 30, (width_cnv2/2)+(taille_plateau*unity/2)+unity*2, 30+unity, fill='red', outline='', tags="rect9-R")),
			# 	"9-0-1-1-R" : (cnv2.create_rectangle((width_cnv2/2)+(taille_plateau*unity/2)+unity, (1*30)+(1*unity), (width_cnv2/2)+(taille_plateau*unity/2)+unity*2, (1*30)+(1*unity)+unity, fill='red', outline='', tags="rect9-R")),
			# 	"9-1-1-2-R" : (cnv2.create_rectangle((width_cnv2/2)+(taille_plateau*unity/2)+unity*2, (1*30)+(1*unity), (width_cnv2/2)+(taille_plateau*unity/2)+unity*3, (1*30)+(1*unity)+unity, fill='red', outline='', tags="rect9-R")),
			# 	"9-2-1-3-R" : (cnv2.create_rectangle((width_cnv2/2)+(taille_plateau*unity/2)+unity*3, (1*30)+(1*unity), (width_cnv2/2)+(taille_plateau*unity/2)+unity*4, (1*30)+(1*unity)+unity, fill='red', outline='', tags="rect9-R")),
			# 	"9-3-1-4-R" : (cnv2.create_rectangle((width_cnv2/2)+(taille_plateau*unity/2)+unity*4, (1*30)+(1*unity), (width_cnv2/2)+(taille_plateau*unity/2)+unity*5, (1*30)+(1*unity)+unity, fill='red', outline='', tags="rect9-R")),

			# "10-0-0-0-R" : (cnv2.create_rectangle((width_cnv2/2)+(taille_plateau*unity/2)+unity, 30, (width_cnv2/2)+(taille_plateau*unity/2)+unity*2, 30+unity, fill='red', outline='', tags="rect10-R")),
			# 	"10-1-0-1-R" : (cnv2.create_rectangle((width_cnv2/2)+(taille_plateau*unity/2)+unity*2, 30, (width_cnv2/2)+(taille_plateau*unity/2)+unity*3, 30+unity, fill='red', outline='', tags="rect10-R")),
			# 	"10-1-1-2-R" : (cnv2.create_rectangle((width_cnv2/2)+(taille_plateau*unity/2)+unity*2, (1*30)+(1*unity), (width_cnv2/2)+(taille_plateau*unity/2)+unity*3, (1*30)+(1*unity)+unity, fill='red', outline='', tags="rect10-R")),
			# 	"10-2-1-3-R" : (cnv2.create_rectangle((width_cnv2/2)+(taille_plateau*unity/2)+unity*3, (1*30)+(1*unity), (width_cnv2/2)+(taille_plateau*unity/2)+unity*4, (1*30)+(1*unity)+unity, fill='red', outline='', tags="rect10-R")),
			# 	"10-3-1-4-R" : (cnv2.create_rectangle((width_cnv2/2)+(taille_plateau*unity/2)+unity*4, (1*30)+(1*unity), (width_cnv2/2)+(taille_plateau*unity/2)+unity*5, (1*30)+(1*unity)+unity, fill='red', outline='', tags="rect10-R")),

			# "11-0-0-0-R" : (cnv2.create_rectangle((width_cnv2/2)+(taille_plateau*unity/2)+unity, 30, (width_cnv2/2)+(taille_plateau*unity/2)+unity*2, 30+unity, fill='red', outline='', tags="rect11-R")),
			# 	"11-1-0-1-R" : (cnv2.create_rectangle((width_cnv2/2)+(taille_plateau*unity/2)+unity*2, 30, (width_cnv2/2)+(taille_plateau*unity/2)+unity*3, 30+unity, fill='red', outline='', tags="rect11-R")),
			# 	"11-0-1-2-R" : (cnv2.create_rectangle((width_cnv2/2)+(taille_plateau*unity/2)+unity, (1*30)+(1*unity), (width_cnv2/2)+(taille_plateau*unity/2)+unity*2, (1*30)+(1*unity)+unity, fill='red', outline='', tags="rect11-R")),
			#  	"11-1-1-3-R" : (cnv2.create_rectangle((width_cnv2/2)+(taille_plateau*unity/2)+unity*2, (1*30)+(1*unity), (width_cnv2/2)+(taille_plateau*unity/2)+unity*3, (1*30)+(1*unity)+unity, fill='red', outline='', tags="rect11-R")),
			# 	"11-2-1-4-R" : (cnv2.create_rectangle((width_cnv2/2)+(taille_plateau*unity/2)+unity*3, (1*30)+(1*unity), (width_cnv2/2)+(taille_plateau*unity/2)+unity*4, (1*30)+(1*unity)+unity, fill='red', outline='', tags="rect11-R")),

			"12-0-0-0-R" : (cnv2.create_rectangle((width_cnv2/2)+(taille_plateau*unity/2)+unity, 30, (width_cnv2/2)+(taille_plateau*unity/2)+unity*2, 30+unity, fill='red', outline='', tags="rect12-R")),
				"12-0-1-1-R" : (cnv2.create_rectangle((width_cnv2/2)+(taille_plateau*unity/2)+unity, (1*30)+(1*unity), (width_cnv2/2)+(taille_plateau*unity/2)+unity*2, (1*30)+(1*unity)+unity, fill='red', outline='', tags="rect12-R")),
   				"12-1-1-2-R" : (cnv2.create_rectangle((width_cnv2/2)+(taille_plateau*unity/2)+unity*2, (1*30)+(1*unity), (width_cnv2/2)+(taille_plateau*unity/2)+unity*3, (1*30)+(1*unity)+unity, fill='red', outline='', tags="rect12-R")),
				"12-2-1-3-R" : (cnv2.create_rectangle((width_cnv2/2)+(taille_plateau*unity/2)+unity*3, (1*30)+(1*unity), (width_cnv2/2)+(taille_plateau*unity/2)+unity*4, (1*30)+(1*unity)+unity, fill='red', outline='', tags="rect12-R")),
				"12-2-0-4-R" : (cnv2.create_rectangle((width_cnv2/2)+(taille_plateau*unity/2)+unity*3, (1*30)+(0*unity), (width_cnv2/2)+(taille_plateau*unity/2)+unity*4, (1*30)+(0*unity)+unity, fill='red', outline='', tags="rect12-R")),
